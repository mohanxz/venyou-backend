...
public class HallDTO {
    ...
    public HallDTO(Hall hall) {
        ...
        this.imagePaths = hall.getImagePaths();
    ...
    public Hall.Status getStatus() { return status; }
    public void setStatus(Hall.Status status) { this.status = status; }
    public List<String> getImagePaths() { return imagePaths; }
    public void setImagePaths(List<String> imagePaths) { this.imagePaths = imagePaths; }
    public String getVirtualTourMap() { return virtualTourMap; }
    public void setVirtualTourMap(String virtualTourMap) { this.virtualTourMap = virtualTourMap; }
    ...
    public String getFeatureBannerImage() { return featureBannerImage; }
    public void setFeatureBannerImage(String featureBannerImage) { this.featureBannerImage = featureBannerImage; }
